...
\draw[thick] (-2,7) -- (8,7);
\draw[thick] (0,2) -- (10,2);
\node[text=black!60!blue!75] at (1.5,6) {\small\sffamily The};
\node[text=black!60!blue!75] at (3.5,4.5) {\small\sffamily Tensor};
\node[text=red!80] at (6.25,4) {\tiny $\otimes$};
\node[text=black!60!blue!75] at (5.5,3){\small\sffamily Space};
\end{tikzpicture}
\end{document}
